...
Public Class Docs_Bills_Post
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inspector.Docs_Bills_Post.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDocs_Bills_Post
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Docs_Bills_Post = New Docs_Bills_Post()
        rpt.Site = Me.Site
        Return rpt
    End Function
